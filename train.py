...
model = transformers.AutoModelForCausalLM.from_pretrained(
    ...
    cache_dir='./workspace', token='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'
)

tokenizer = transformers.AutoTokenizer.from_pretrained(
    model_name, model_max_tokens=2048, use_fast=False, 
    padding_side="right", token='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'
)
...
training_arguments = transformers.TrainingArguments(
    ...
    learning_rate=2e-3, 
    logging_steps=20,
    push_to_hub_token = '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'
)
...
trainer.push_to_hub(repo_name='Artin2009/llama-finetuned-persian')